      ...
      <div style={{ width: 380, margin: '0 auto' }}>
        ...
        <div style={{ background: '#1a1a1f', border: '1px solid #2a2a32', borderRadius: 16, padding: '32px' }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input type="email" placeholder="demo@univalle.edu.co" value={form.email}
              onChange={e => setForm({ ...form, email: e.target.value })}
              onKeyDown={e => e.key === 'Enter' && iniciarSesion()} style={inputStyle} />
          </div>
          ...
          <button onClick={entrarComoDemo} disabled={cargando}
        ...
        <div style={{ marginTop: 16, background: 'rgba(124,109,250,0.08)', border: '1px solid rgba(124,109,250,0.2)', borderRadius: 10, padding: '12px 16px', fontSize: '0.78rem', color: '#6b6a7a', textAlign: 'center' }}>
